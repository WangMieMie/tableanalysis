      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          >
            ...
            {googleLoading ? t('loading') || 'Creating account...' : t('googleSignUp') || 'Continue with Google'}
          </Button>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-gray-500">{t('or') || 'or'}</span>
            </div>
          </div>
          ...
          <form action={handleEmailSignup}>
            <div className="space-y-4">
              ...
              <Button type="submit" className="w-full" disabled={isLoading}>
                {isLoading ? t('loading') || 'Creating account...' : t('submit')}
              </Button>
            </div>
          </form>
        </CardContent>
